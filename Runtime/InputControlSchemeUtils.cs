...
namespace Audune.Utils.InputSystem
{
  ...
  public static class InputControlSchemeUtils
  {
    ...
    public static IEnumerable<ControlSchemeReference> GetAvailableControlSchemes<TDevices>(this InputActionAsset actionAsset, TDevices devices, bool includeMostSpecificOnly = false) where TDevices : IReadOnlyList<InputDevice>
    {
      ...
      var availableControlSchemes = new List<(ControlSchemeReference scheme, float score)>();
      foreach (var controlScheme in actionAsset.controlSchemes)
      {
        ...
        if (result.isSuccessfulMatch)
          availableControlSchemes.Add((new ControlSchemeReference(controlScheme, result.devices.ToArray()), result.score));
      }
    ...
    public static IEnumerable<ControlSchemeReference> GetAvailableControlSchemes(this InputActionAsset actionAsset, bool includeMostSpecificOnly = false)
    {
      return GetAvailableControlSchemes(actionAsset, UnityEngine.InputSystem.InputSystem.devices, includeMostSpecificOnly);
    }
    #endregion
    ...
    public static bool MatchesAvailableControlScheme<TDevices>(this InputActionAsset actionAsset, TDevices devices, InputControl control, out ControlSchemeReference controlScheme, out string controlPath, bool includeMostSpecificOnly = false) where TDevices : IReadOnlyList<InputDevice>
    {
      controlScheme = null;
      controlPath = null;
    ...
    public static bool MatchesAvailableControlScheme(this InputActionAsset actionAsset, InputControl control, out ControlSchemeReference controlScheme, out string controlPath, bool includeMostSpecificOnly = false)
    {
      return MatchesAvailableControlScheme(actionAsset, UnityEngine.InputSystem.InputSystem.devices, control, out controlScheme, out controlPath, includeMostSpecificOnly);
    }
    #endregion
  }
}